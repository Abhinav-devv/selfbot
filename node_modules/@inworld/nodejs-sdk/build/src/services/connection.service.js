...
class ConnectionService {
    constructor(props) {
        var _a;
        this.state = interfaces_1.ConnectionState.INACTIVE;
        ...
        if (this.connectionProps.onMessage) {
            this.onMessage = (packet) => __awaiter(this, void 0, void 0, function* () { return this.connectionProps.onMessage(event_1.EventFactory.fromProto(packet)); });
        }
    }
    isActive() {
        return this.state === interfaces_1.ConnectionState.ACTIVE;
    }
    isAutoReconnected() {
        var _a, _b, _c;
    ...
    open() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.loadScene();
                if (this.state === interfaces_1.ConnectionState.LOADED) {
                    this.state = interfaces_1.ConnectionState.ACTIVATING;
                    ...
                    this.state = interfaces_1.ConnectionState.ACTIVE;
                    this.releaseQueue();
    ...
    write(getPacket) {
        ...
        const resolvePacket = () => new Promise((resolve) => {
            const done = (packet) => {
                this.scheduleDisconnect();
                resolve(event_1.EventFactory.fromProto(packet));
            };
            if (packet) {
                return done(packet);
            }
            const interval = setInterval(() => {
                if (packet || this.state === interfaces_1.ConnectionState.INACTIVE) {
    ...
    loadScene() {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            if (this.state === interfaces_1.ConnectionState.LOADING)
                return;
            let session;
            let changed = false;
            ...
            try {
                ...
                if ([interfaces_1.ConnectionState.LOADING, interfaces_1.ConnectionState.INACTIVE].includes(this.state)) {
                    this.state = interfaces_1.ConnectionState.LOADED;
                }
            }
            catch (err) {
                this.onError(err);
    ...
    getOrLoadSessionToken(savedSessionToken) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!sessionToken || session_token_entity_1.SessionToken.isExpired(sessionToken)) {
                this.state = interfaces_1.ConnectionState.LOADING;
